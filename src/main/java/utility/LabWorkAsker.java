...
//    private java.util.Date creationDate; //Поле не может быть null, Значение этого поля должно генерироваться автоматически
    ...
    public String askLogin() throws IncorrectScriptException {
        String name = "";
        if (!isFileMode())
        ...
        while (true) {
            try {
                ...
                System.out.println("Логин не может содержать символ ';'");
            } catch (Exception e) {
                if (!isScriptMode())
                    System.out.println("Ошибка. Повторите ввод");
                else throw new IncorrectScriptException();
    ...
    public String askPassword() throws IncorrectScriptException {
        String name = "";
        if (!isFileMode())
        ...
        while (true) {
            try {
                ...
                System.out.println("Пароль не может содержать символ ';'");
            } catch (Exception e) {
                if (!isScriptMode())
                    System.out.println("Ошибка. Повторите ввод");
                else throw new IncorrectScriptException();
